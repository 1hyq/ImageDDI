...
def loadSmilesAndSave(smis, path):
    '''
        ...
        demo:
            ...
            for drug_id, smiles in enumerate(smiless):
                loadSmilesAndSave(smiles, "{}.png".format(drug_id))
        ==============================================================================================================
...
def main():
    ...
    parser.add_argument('--dataroot', type=str, default="./datasets/Deng's-dataset/", help='data root')
    ...
    img_save_root = os.path.join(args.dataroot, args.dataset, "ImageDDI")
    csv_save_path = os.path.join(args.dataroot, args.dataset, "{}_drug.csv".format(args.dataset))
